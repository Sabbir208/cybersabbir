...
dtls=(yellow+"\t\t Created By: Sabbir ")

note=(cyan+"Note: It's only for fun. i wont be responsible fo any illigal activites. >> This CYBER SABBIR tool is for use in Bangladesh only. Use our Global version for worldwide use.")
...
print('					')
print(cyan+'\t\tThanks For Using CYBERSABBIR Bangladesh By Sabbir - CYBER SABBIR Team')
